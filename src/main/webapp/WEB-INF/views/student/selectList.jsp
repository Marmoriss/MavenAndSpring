...
<div id="student-container">
            ...
            <c:forEach items="${list}" var="student">
                <tr>
                	...
                	<td>
                        ...
                        <fmt:formatDate value="${updatedAt}" pattern="yyyy/MM/dd HH:mm"/>
                    </td>
                </tr>
            </c:forEach>
		</tbody>
    ...
    <table class="tbl-student">
        ...
        <tbody>
            <c:forEach items="${mapList}" var="mapStudent">
                <tr>
                    <td>${mapStudent.no}</td>
                    <td>${mapStudent.name}</td>
                    <td>${mapStudent.tel}</td>
                    <td><fmt:formatDate value="${mapStudent.createdAt}" pattern="yyyy/MM/dd HH:mm"/></td>
                    <td><fmt:formatDate value="${mapStudent.updatedAt}" pattern="yyyy/MM/dd HH:mm"/> </td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
